...
document.head.appendChild(imported);
		...
		var isMobile = false; //initiate as false
			...
			if  (!isMobile) {
				content = '<img id="image-input" src="th.jpg">';
			}
			if  (isMobile) {
				content = '<video id="camera-input" autoplay playsinline></video>';
			}
			$("#camera").prepend( content );
		
// https://blog.prototypr.io/make-a-camera-web-app-tutorial-part-1-ec284af8dddf
// Set constraints for the video stream
var constraints = { video: { facingMode: "environment" }, audio: false };
// Define constants
const cameraView = document.querySelector("#camera-input");
